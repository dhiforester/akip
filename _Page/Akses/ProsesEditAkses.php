            ...
            if(empty($_POST['kontak'])){
                ...
                if(empty($_POST['email'])){
                    ...
                    if(empty($_POST['akses'])){
                        echo '<code class="text-danger">Akses tidak boleh kosong</code>';
                    }else{
                            ...
                            if($JumlahKarakterKontak>20||$JumlahKarakterKontak<6||!preg_match("/^[0-9]*$/", $kontak)){
                                ...
                                if(!empty($ValidasiKontakDuplikat)){
                                    ...
                                    if(!empty($ValidasiEmailDuplikat)){
                                        ...
                                        //Validasi Kelengkapan Wilayah Berdasarkan Hak Akses
                                        if($akses=="Admin"){
                                            $id_wilayah="0";
                                            $ValidasiKelengkapanWilayah="Valid";
                                        }else{
                                            if($akses=="Provinsi"){
                                                if(empty($_POST['provinsi'])){
                                                    $id_wilayah="0";
                                                    $ValidasiKelengkapanWilayah="Provinsi Tidak Boleh Kosong";
                                                }else{
                                                    $id_wilayah=$_POST['provinsi'];
                                                    $ValidasiKelengkapanWilayah="Valid";
                                                }
                                            }else{
                                                if($akses=="Kabupaten"){
                                                    if(empty($_POST['kabupaten'])){
                                                        $id_wilayah="0";
                                                        $ValidasiKelengkapanWilayah="Kabupaten Tidak Boleh Kosong";
                                                    }else{
                                                        $id_wilayah=$_POST['kabupaten'];
                                                        $ValidasiKelengkapanWilayah="Valid";
                                                    }
                                                }else{
                                                    if($akses=="Kecamatan"){
                                                        if(empty($_POST['kecamatan'])){
                                                            $id_wilayah="0";
                                                            $ValidasiKelengkapanWilayah="Kecamatan Tidak Boleh Kosong";
                                                        }else{
                                                        ...
                                                        if($akses=="Desa"){
                                                            if(empty($_POST['desa'])){
                                                                $id_wilayah="0";
                                                                $ValidasiKelengkapanWilayah="Desa Tidak Boleh Kosong";
                                                            }else{
                                        ...
                                        if($ValidasiKelengkapanWilayah!=="Valid"){
                                            echo '<small class="text-danger">'.$ValidasiKelengkapanWilayah.'</small>';
                                        }else{
                                            //Validasi Gambar
