...
<script>
    ...
    $('#NextPage').click(function() {
        ...
        $.ajax({
            url     : "_Page/FiturAkses/TabelFiturAkses.php",
            method  : "POST",
...
<div class="row mb-3">
    <?php
        if(empty($jml_data)){
            ...
            echo '          Tidak Ada Data Fitur Yang Ditemukan';
            echo '      </div>';
            echo '  </div>';
            echo '</div>';
        }else{
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                if($akses=="Admin"){
                    ...
                    if($akses=="Provinsi"){
                        ...
                        if($akses=="Kabupaten"){
                            $LabelAkses='<i class="bi bi-star"></i> Kab/Kota';
                        }else{
                            if($akses=="Kecamatan"){
                                $LabelAkses='<i class="bi bi-star"></i> Kecamatan';
                            }else{
                                if($akses=="Desa"){
                                    $LabelAkses='<i class="bi bi-star"></i> Kel/Desa';
                                }else{
                                    $LabelAkses='No Data';
                                }
                            }
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="javascript:void(0);" class="card-title" data-bs-toggle="modal" data-bs-target="#ModalDetailFitur" data-id="<?php echo "$id_akses_fitur"; ?>" title="Lihat Detai Fitur">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <code class="text-dark" title="Kategori Fitur">
                                <i class='bi bi-tag'></i> <?php echo "$kategori"; ?>
                            </code>
                        </div>
                        <div class="col-md-3">
                            <code class="text-dark" title="Kode Fitur">
                                <i class='bi bi-at'></i> <?php echo "$kode"; ?>
                            </code>
                        </div>
                        <div class="col-md-2">
                            <code class="text-dark" title="Pengguna Fitur">
