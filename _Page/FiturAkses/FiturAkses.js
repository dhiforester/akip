...
function filterAndLoadTable() {
    ...
    $('#MenampilkanTabelFitur').html('<div class="row"><div class="col-md-12 text-center">Loading...</div></div>');
    $.ajax({
        type: 'POST',
...
$('#KeywordBy').change(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/FormFilter.php',
...
$('#ProsesTambahFitur').submit(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/ProsesTambahFitur.php',
        ...
        success     : function(data){
            ...
            if(NotifikasiTambahAksesFiturBerhasil=="Success"){
                ...
                swal("Success!", "Tambahh Fitur Akses Berhasil!", "success");
                //Menampilkan Data
                filterAndLoadTable();
            }
        }
...
$('#ModalHapusFitur').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/FormHapusFitur.php',
...
$('#ProsesHapusFitur').submit(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/ProsesHapusFitur.php',
        ...
        success     : function(data){
            ...
            if(NotifikasiHapusFiturBerhasil=="Success"){
                ...
                swal("Success!", "Hapus Fitur Akses Berhasil!", "success");
                //Menampilkan Data
                filterAndLoadTable();
            }
        }
...
$('#ModalEditFitur').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/FormEditFitur.php',
        data        : {id_akses_fitur: GetData},
        success     : function(data){
...
$('#ProsesEditFitur').submit(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/ProsesEditFitur.php',
        ...
        success     : function(data){
            ...
            if(NotifikasiEditFiturBerhasil=="Success"){
                ...
                swal("Success!", "Edit Fitur Akses Berhasil!", "success");
                //Menampilkan Data
                filterAndLoadTable();
            }
        }
...
//Ketika Modal Detail Fitur Muncul
$('#ModalDetailFitur').on('show.bs.modal', function (e) {
    var GetData = $(e.relatedTarget).data('id');
    $('#FormDetailFitur').html("Loading...");
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/FiturAkses/FormDetailFitur.php',
        data        : {id_akses_fitur: GetData},
        success     : function(data){
