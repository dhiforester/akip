        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    swal("Success", "Tambah Provinsi Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Edit Provinsi Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Hapus Provinsi Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Tambah Kbupaten/Kota Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Edit Kabupaten/Kota Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Hapus Kabupaten/Kota Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Tambah OPD Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Edit OPD Berhasil!", "success");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === "Success") {
                    ...
                    // Tampilkan swal notifikasi
                    swal("Success", "Hapus OPD Berhasil!", "success");
