<?php
    $tahun_ini=date('Y');
    //Menghitung Jumlah
    $JumlahKecamatan = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM wilayah WHERE kabupaten='Kab. Kuningan' AND kategori='Kecamatan'"));
    $JumlahDesa = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM wilayah WHERE kabupaten='Kab. Kuningan' AND kategori='desa'"));
?>
                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-img-overlay">
                            <h5 class="card-title text-light">Kecamatan</h5>
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center text-light bg-grayish">
                                    <i class="bi bi-grid-3x3"></i>
                                </div>
                                <div class="ps-3" class="text-light">
                                    <h3 class="text-light"><?php echo "$JumlahKecamatan";?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <small>Data Tahun 2019</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
