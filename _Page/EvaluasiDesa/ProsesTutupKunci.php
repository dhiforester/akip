<?php
    ...
    if(empty($_POST['id_file_store'])){
        ...
        if($Update){
            ...
            $deskripsi_log="Tutup Kunci File Berhasil";
            $InputLog=addLog($Conn,$SessionIdAkses,$now,$kategori_log,$deskripsi_log);
            if($InputLog=="Success"){
                $_SESSION['NotifikasiSwal']="Tutup Kunci Berhasil";
                echo '<small class="text-success" id="NotifikasiTutupKunciBerhasil">Success</small>';
            }else{
