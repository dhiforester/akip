<?php
    ...
    if(empty($_POST['id_evaluasi'])){
        ...
        //Validasi id_referensi_bukti tidak boleh kosong
        if(empty($_POST['id_referensi_bukti'])){
            echo '<small class="text-danger">ID Referensi Bukti tidak boleh kosong</small>';
        }else{
            //Validasi file_draft tidak boleh kosong
                    ...
                    if($UkuranFile>$MaxFile){
                        ...
                        if(move_uploaded_file($tmp_file, $path)){
                            ...
                            if($Input){
                                ...
                                $deskripsi_log="Upload File Bukti Baru Berhasil";
                                $InputLog=addLog($Conn,$SessionIdAkses,$now,$kategori_log,$deskripsi_log);
                                if($InputLog=="Success"){
                                    $_SESSION['NotifikasiSwal']="Upload File Berhasil";
                                    echo '<small class="text-success" id="NotifikasiUploadDraftBerhasil">Success</small>';
                                }else{
