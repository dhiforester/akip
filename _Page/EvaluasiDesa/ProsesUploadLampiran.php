            ...
            if(empty($_POST['id_kriteria_indikator'])){
                ...
                if(empty($_POST['label_file'])){
                    ...
                    if(empty($_FILES['file_name']['name'])){
                        ...
                        //Cek Apakah Sudah Punya Evaluasi Jawaban?
                        $Qry= mysqli_query($Conn,"SELECT * FROM evaluasi_jawaban WHERE id_evaluasi='$id_evaluasi' AND id_wilayah='$id_wilayah' AND id_kriteria_indikator='$id_kriteria_indikator'")or die(mysqli_error($Conn));
                        $Data = mysqli_fetch_array($Qry);
                        if(empty($Data['id_evaluasi_jawaban'])){
                            $id_evaluasi_jawaban="";
                        }else{
                            $id_evaluasi_jawaban=$Data['id_evaluasi_jawaban'];
                        }
