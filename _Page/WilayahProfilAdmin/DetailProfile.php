<?php
    ...
    $IjinAksesSaya=IjinAksessaya($Conn,$SessionIdAkses,'mZ51LcaDOR');
        ...
        <div class="row">
            <div class="col-md-12">
                <?php
                    ...
                    echo '  Berikut ini adalah halaman untuk menampilkan informasi identitas wilayah.';
                    echo '  Informasi yang ada pada halaman ini hanya bisa di ubah oleh pemilik otoritas wilayah.';
            ...
            <script id="code">
                function init() {
                    ...
                    $(go.Link, go.Link.Orthogonal,
                        ...
                        var nodeDataArray=[
                            <?php
                                $QrySo = "SELECT * FROM struktur_organisasi WHERE id_wilayah='$id_wilayah'";
