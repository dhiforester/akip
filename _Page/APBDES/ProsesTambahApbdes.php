                                                        ...
                                                        if (!in_array($TipeFile, $allowedTypes)) {
                                                            ...
                                                            if ($UkuranFile > $maxSize) {
                                                                ...
                                                                if(!move_uploaded_file($TmpFile, $path)){
                                                                    ...
                                                                    if($Input){
                                                                        $kategori_log="APBDES";
                                                                        $deskripsi_log="Tambah APBDES Berhasil";
                                                                        $InputLog=addLog($Conn,$SessionIdAkses,$now,$kategori_log,$deskripsi_log);
                                                                        if($InputLog=="Success"){
                                                                            $_SESSION['NotifikasiSwal']="Tambah APBDES Berhasil";
                                                                            echo '<small class="text-success" id="NotifikasiTambahApbdesBerhasil">Success</small>';
                                                                        }else{
