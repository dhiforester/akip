                ...
                if(empty($_POST['max_file'])){
                    ...
                    if(!preg_match("/^[0-9]*$/", $max_file)){
                        ...
                        if(empty($JumlahType)){
                            ...
                            $entry="INSERT INTO referensi_bukti (
                                nama_bukti,
                                single_multi,
                                type_file,
                                max_file,
                            ...
                            if($Input){
                                ...
                                $deskripsi_log="Tambah Lampiran Bukti Berhasil";
                                $InputLog=addLog($Conn,$SessionIdAkses,$now,$kategori_log,$deskripsi_log);
                                if($InputLog=="Success"){
                                    echo '<small class="text-success" id="NotifikasiTambahLampiranBuktiBerhasil">Success</small>';
                                }else{
