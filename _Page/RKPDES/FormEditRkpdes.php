...
?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="text" readonly name="periode_rkpdes" id="periode_rkpdes" class="form-control" value="<?php echo $periode;?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <small class="credit">Jumlah Total Anggaran Pada RKPDES</small>
                    </div>
                </div>
<?php
            }
