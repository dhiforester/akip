<?php
    ...
    // Insert Data
    $query_insert = "INSERT INTO opd (id_provinsi, id_kabkot, nama_opd, telepon, alamat) VALUES (?, ?, ?, ?, ?)";
    $stmt_insert = $Conn->prepare($query_insert);

    if ($stmt_insert) {
        $stmt_insert->bind_param("iisss", $id_provinsi,  $id_kabkot, $opd, $telepon, $alamat);
